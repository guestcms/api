...
namespace GuestCMS\Api\Facades;

use GuestCMS\Api\Supports\ApiHelper as ApiHelperSupport;
use Illuminate\Support\Facades\Facade;

/**
 * @method static string modelName()
 * @method static \GuestCMS\Api\Supports\ApiHelper setModelName(string $modelName)
 ...
 *
 * @see \GuestCMS\Api\Supports\ApiHelper
 */
